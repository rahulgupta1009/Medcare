...
const Home = () => {
  ...
  {/* hero section*/}
   ...
   <section>
    <div className='container'>
      <div className='lg:w-[470px] mx-auto'>
        ...
        <p className='text__para text-center'>World-class care for everyone. 
   ...
   <section>
    <div className='container'>
      <div className='flex itens-center justify-between flex-col lg:flex-row'>
        {/* feature content */}
        <div className='xl:w-[670px]'>
          ...
          <ul className="pl-4">
            <li className="text__para">1. Schedule the appointment directly.
            </li>
            <li className='text__para'>2. Search for your physician here, and contact their office.
            </li>
            <li className='text__para'>
              3. View our physicians who are accepting new patients, 
              use the online schedule tool to select an appointment time
            </li>
          </ul>
          <Link to='/'>
